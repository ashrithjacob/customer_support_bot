...
if __name__ == "__main__":
    with open("ChatTranscriptsSGS.txt", "r") as file:
        file_contents = file.read()
    runner = CombineTables(chunk_size=2, file_contents=file_contents)
    for (idx,clump) in enumerate(runner.clumps):
        ...
        print("combined table:",json.dumps(runner.combined_table, indent=2))
